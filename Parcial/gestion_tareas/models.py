...
class Tarea(models.Model):
    ...
    Fecha_de_creacion=models.CharField(max_length=64,default='')
    Fecha_de_entrega=models.CharField(max_length=64,default='')
...
class Usuario(models.Model):
    ...
    Codigo_de_usuario=models.CharField(max_length=64,default='')
